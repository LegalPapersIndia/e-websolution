...
function PricingCard({ pricing: { plan,  description, duration, pricePerMonth, originalPrice, savings, payToday, renewsAt, gstNote, price, img, features, highlighted, featureIcon }, frequency }) {
	...
	return (
		<div className={`sofax-pricing-wrap ${highlighted ? "recommended" : ""}`}>
			...
			<div className="sofax-pricing-price">
				<h3>₹{price.find(item => item.id === frequency.id)?.value}k</h3>
				<p className="dynamic-value">{frequency.label}</p>
			</div> */}
			<div className="pricing-card-header">
				...
				<div className="pricing-info-box">
					<div className="pricing-top-row">
						...
						<span className="pricing-unit">/mo</span>
					</div>

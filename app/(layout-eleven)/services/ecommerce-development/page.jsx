...
import Banner from "@/public/images/services/ecommerce-development/banner.jpg";
import Thumb from "@/public/images/v10/thumb7v10.png";
...
function SingleService() {
	return (
		<>
			<BreadCrumb title="E-commerce Development" bgImage={Banner} />
			<Hero serviceId={6} imageSrc={Thumb} />
			<Features />
			<AutoSlider />

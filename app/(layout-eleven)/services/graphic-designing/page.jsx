...
import Banner from "@/public/images/services/graphic-design/banner.jpg";
import Thumb from "@/public/images/v10/thumb6v10.png";
...
function SingleService() {
	return (
		<>
			<BreadCrumb title="Logo & Graphic Designing" bgImage={Banner} />

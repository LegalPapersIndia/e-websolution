...
import Banner from "@/public/images/services/app-development/banner.jpg"
import Thumb from "@/public/images/v10/thumb5v10.png";
...
function SingleService() {
	return (
		<>
			<BreadCrumb title="App Development" bgImage={Banner} />
			<Hero serviceId={4} imageSrc={Thumb} />
			<Features />
			<AutoSlider />
